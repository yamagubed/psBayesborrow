...
namespace model_T2ECauchyC0_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 36, column 2 to line 37, column 63)",
...
class model_T2ECauchyC0 final : public model_base_crtp<model_T2ECauchyC0> {
private:
  int nCT_o;
  int nCT_c;
  int nCC_o;
...
public:
  ...
  inline std::string model_name() const final { return "model_T2ECauchyC0"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_T2ECauchyC0(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_T2ECauchyC0_namespace::model_T2ECauchyC0";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_T2ECauchyC0_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_T2ECauchyC0_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_T2ECauchyC0_namespace::model_T2ECauchyC0;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_T2ECauchyC0_namespace::profiles__;
}
#endif
#endif
