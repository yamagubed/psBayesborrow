...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_T2ECauchyC0");
    reader.add_event(45, 43, "end", "model_T2ECauchyC0");
    return reader;
}
#include <stan_meta_header.hpp>
class model_T2ECauchyC0
  : public stan::model::model_base_crtp<model_T2ECauchyC0> {
private:
        int nCT_o;
        int nCT_c;
        int nCC_o;
...
typedef model_T2ECauchyC0_namespace::model_T2ECauchyC0 stan_model;
#ifndef USING_R
