...
#include "stanExports_T2ENormalC0.h"

RCPP_MODULE(stan_fit4T2ENormalC0_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_T2ENormalC0")
