...
#include "stanExports_T2ENoborrow.h"

RCPP_MODULE(stan_fit4T2ENoborrow_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_T2ENoborrow")
