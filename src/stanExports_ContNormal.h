...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ContNormal");
    reader.add_event(34, 32, "end", "model_ContNormal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ContNormal
  : public stan::model::model_base_crtp<model_ContNormal> {
private:
        int nCT;
        int nCC;
        int nEC;
...
typedef model_ContNormal_namespace::model_ContNormal stan_model;
#ifndef USING_R
