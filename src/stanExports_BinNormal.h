...
namespace model_BinNormal_namespace {
...
class model_BinNormal final : public model_base_crtp<model_BinNormal> {
private:
  int nCT;
  int nCC;
  int nEC;
...
public:
  ~model_BinNormal() {}
  model_BinNormal(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_BinNormal_namespace::model_BinNormal";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      current_statement__ = 23;
      yEC = context__.vals_i("yEC");
      current_statement__ = 23;
      stan::math::check_greater_or_equal(function__, "yEC", yEC, 0);
      current_statement__ = 23;
      stan::math::check_less_or_equal(function__, "yEC", yEC, 1);
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_BinNormal_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_BinNormal_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"theta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"gammaCC\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"gammaEC\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"}]");
  }
...
using stan_model = model_BinNormal_namespace::model_BinNormal;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_BinNormal_namespace::profiles__;
}
#endif
#endif
