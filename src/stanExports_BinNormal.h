...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BinNormal");
    reader.add_event(33, 31, "end", "model_BinNormal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BinNormal
  : public stan::model::model_base_crtp<model_BinNormal> {
private:
        int nCT;
        int nCC;
        int nEC;
        ...
        double scale;
public:
    model_BinNormal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_BinNormal_namespace::model_BinNormal";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "yEC", "int", context__.to_vec(nEC));
            yEC = std::vector<int>(nEC, int(0));
            vals_i__ = context__.vals_i("yEC");
            pos__ = 0;
            size_t yEC_k_0_max__ = nEC;
            for (size_t k_0__ = 0; k_0__ < yEC_k_0_max__; ++k_0__) {
                yEC[k_0__] = vals_i__[pos__++];
            }
            size_t yEC_i_0_max__ = nEC;
            for (size_t i_0__ = 0; i_0__ < yEC_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "yEC[i_0__]", yEC[i_0__], 0);
                check_less_or_equal(function__, "yEC[i_0__]", yEC[i_0__], 1);
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= nEC; ++i) {
                ...
                lp_accum__.add(bernoulli_log<propto__>(get_base1(yEC, i, "yEC", 1), inv_logit((gammaEC + multiply(get_base1(xEC, i, "xEC", 1), beta)))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_BinNormal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_BinNormal_namespace::model_BinNormal stan_model;
#ifndef USING_R
