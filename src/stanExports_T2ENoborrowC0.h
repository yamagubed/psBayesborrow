...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_T2ENoborrowC0");
    reader.add_event(29, 27, "end", "model_T2ENoborrowC0");
    return reader;
}
#include <stan_meta_header.hpp>
class model_T2ENoborrowC0
  : public stan::model::model_base_crtp<model_T2ENoborrowC0> {
private:
        int nCT_o;
        int nCT_c;
        int nCC_o;
...
typedef model_T2ENoborrowC0_namespace::model_T2ENoborrowC0 stan_model;
#ifndef USING_R
