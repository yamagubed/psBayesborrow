...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_T2ECauchy");
    reader.add_event(50, 48, "end", "model_T2ECauchy");
    return reader;
}
#include <stan_meta_header.hpp>
class model_T2ECauchy
  : public stan::model::model_base_crtp<model_T2ECauchy> {
private:
        int nCT_o;
        int nCT_c;
        int nCC_o;
...
typedef model_T2ECauchy_namespace::model_T2ECauchy stan_model;
#ifndef USING_R
