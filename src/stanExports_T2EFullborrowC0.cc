...
#include "stanExports_T2EFullborrowC0.h"

RCPP_MODULE(stan_fit4T2EFullborrowC0_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_T2EFullborrowC0")
