...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_T2ENormal");
    reader.add_event(50, 48, "end", "model_T2ENormal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_T2ENormal
  : public stan::model::model_base_crtp<model_T2ENormal> {
private:
        int nCT_o;
        int nCT_c;
        int nCC_o;
...
typedef model_T2ENormal_namespace::model_T2ENormal stan_model;
#ifndef USING_R
