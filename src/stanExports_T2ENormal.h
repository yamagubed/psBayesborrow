...
public:
  ...
  inline std::string model_name() const final { return "model_T2ENormal"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_T2ENormal(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_T2ENormal_namespace::model_T2ENormal";
    ...
    try {
      ...
      current_statement__ = 27;
      current_statement__ = 27;
      check_greater_or_equal(function__, "nCT_o", nCT_o, 0);
      ...
      current_statement__ = 28;
      current_statement__ = 28;
      check_greater_or_equal(function__, "nCT_c", nCT_c, 0);
      ...
      current_statement__ = 29;
      current_statement__ = 29;
      check_greater_or_equal(function__, "nCC_o", nCC_o, 0);
      ...
      current_statement__ = 30;
      current_statement__ = 30;
      check_greater_or_equal(function__, "nCC_c", nCC_c, 0);
      ...
      current_statement__ = 31;
      current_statement__ = 31;
      check_greater_or_equal(function__, "nEC_o", nEC_o, 0);
      ...
      current_statement__ = 32;
      current_statement__ = 32;
      check_greater_or_equal(function__, "nEC_c", nEC_c, 0);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_T2ENormal_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      }
      {
        ...
        lp_accum__.add(normal_lpdf<propto__>(tau, 0, scale));
        ...
        for (int i = 1; i <= nCC_o; ++i) {
          ...
          lp_accum__.add(
            weibull_lpdf<propto__>(yCC_o[(i - 1)], alpha,
              stan::math::exp(
                (-(gammaCC + multiply(xCC_o[(i - 1)], beta)) / alpha))));}
        ...
        for (int i = 1; i <= nEC_o; ++i) {
          ...
          lp_accum__.add(
            weibull_lpdf<propto__>(yEC_o[(i - 1)], alpha,
              stan::math::exp(
                (-(gammaEC + multiply(xEC_o[(i - 1)], beta)) / alpha))));}
        current_statement__ = 18;
        if (logical_gt(nCT_c, 0)) {
          ...
          for (int i = 1; i <= nCC_c; ++i) {
            ...
            lp_accum__.add(
              weibull_lccdf(yCC_c[(i - 1)], alpha,
                stan::math::exp(
                  (-(gammaCC + multiply(xCC_c[(i - 1)], beta)) / alpha))));}
        } 
        current_statement__ = 26;
        if (logical_gt(nEC_c, 0)) {
          ...
          for (int i = 1; i <= nEC_c; ++i) {
            ...
            lp_accum__.add(
              weibull_lccdf(yEC_c[(i - 1)], alpha,
                stan::math::exp(
                  (-(gammaEC + multiply(xEC_c[(i - 1)], beta)) / alpha))));}
        } 
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_T2ENormal_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
