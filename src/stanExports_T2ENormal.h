...
namespace model_T2ENormal_namespace {
...
class model_T2ENormal final : public model_base_crtp<model_T2ENormal> {
private:
  int nCT_o;
  int nCT_c;
  int nCC_o;
...
public:
  ~model_T2ENormal() {}
  model_T2ENormal(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_T2ENormal_namespace::model_T2ENormal";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_T2ENormal_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_T2ENormal_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_T2ENormal_namespace::model_T2ENormal;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_T2ENormal_namespace::profiles__;
}
#endif
#endif
