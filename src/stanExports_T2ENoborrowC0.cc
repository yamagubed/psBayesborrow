...
#include "stanExports_T2ENoborrowC0.h"

RCPP_MODULE(stan_fit4T2ENoborrowC0_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_T2ENoborrowC0")
