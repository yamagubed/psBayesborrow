...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ContNoborrow");
    reader.add_event(23, 21, "end", "model_ContNoborrow");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ContNoborrow
  : public stan::model::model_base_crtp<model_ContNoborrow> {
private:
        int nCT;
        int nCC;
        int p;
...
typedef model_ContNoborrow_namespace::model_ContNoborrow stan_model;
#ifndef USING_R
