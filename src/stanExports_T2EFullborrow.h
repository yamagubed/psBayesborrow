...
public:
  ...
  inline std::string model_name() const final { return "model_T2EFullborrow"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_T2EFullborrow(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_T2EFullborrow_namespace::model_T2EFullborrow";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_T2EFullborrow_namespace::log_prob";
(void) function__;  // suppress unused var warning
        ...
        for (int i = 1; i <= nEC_o; ++i) {
          ...
          lp_accum__.add(
            weibull_lpdf<propto__>(yEC_o[(i - 1)], alpha,
              stan::math::exp(
                (-(gammaCC + multiply(xEC_o[(i - 1)], beta)) / alpha))));}
          ...
          for (int i = 1; i <= nEC_c; ++i) {
            ...
            lp_accum__.add(
              weibull_lccdf(yEC_c[(i - 1)], alpha,
                stan::math::exp(
                  (-(gammaCC + multiply(xEC_c[(i - 1)], beta)) / alpha))));}
        } 
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_T2EFullborrow_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
