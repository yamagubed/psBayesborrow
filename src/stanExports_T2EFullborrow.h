...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_T2EFullborrow");
    reader.add_event(44, 42, "end", "model_T2EFullborrow");
    return reader;
}
#include <stan_meta_header.hpp>
class model_T2EFullborrow
  : public stan::model::model_base_crtp<model_T2EFullborrow> {
private:
        int nCT_o;
        int nCT_c;
        int nCC_o;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "nCC_c", "int", context__.to_vec());
            nCC_c = int(0);
            vals_i__ = context__.vals_i("nCC_c");
            pos__ = 0;
            nCC_c = vals_i__[pos__++];
            ...
            context__.validate_dims("data initialization", "yCC_c", "vector_d", context__.to_vec(nCC_c));
            yCC_c = Eigen::Matrix<double, Eigen::Dynamic, 1>(nCC_c);
            vals_r__ = context__.vals_r("yCC_c");
            pos__ = 0;
            size_t yCC_c_j_1_max__ = nCC_c;
            for (size_t j_1__ = 0; j_1__ < yCC_c_j_1_max__; ++j_1__) {
                yCC_c(j_1__) = vals_r__[pos__++];
            }
            ...
            context__.validate_dims("data initialization", "xCC_c", "row_vector_d", context__.to_vec(nCC_c,p));
            xCC_c = std::vector<Eigen::Matrix<double, 1, Eigen::Dynamic> >(nCC_c, Eigen::Matrix<double, 1, Eigen::Dynamic>(p));
            vals_r__ = context__.vals_r("xCC_c");
            pos__ = 0;
            size_t xCC_c_j_1_max__ = p;
            size_t xCC_c_k_0_max__ = nCC_c;
            for (size_t j_1__ = 0; j_1__ < xCC_c_j_1_max__; ++j_1__) {
                for (size_t k_0__ = 0; k_0__ < xCC_c_k_0_max__; ++k_0__) {
                    xCC_c[k_0__](j_1__) = vals_r__[pos__++];
                }
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= nEC_o; ++i) {
                ...
                lp_accum__.add(weibull_log<propto__>(get_base1(yEC_o, i, "yEC_o", 1), alpha, stan::math::exp((-((gammaCC + multiply(get_base1(xEC_o, i, "xEC_o", 1), beta))) / alpha))));
            }
            ...
            for (int i = 1; i <= nCC_c; ++i) {
                ...
                lp_accum__.add(weibull_ccdf_log(get_base1(yCC_c, i, "yCC_c", 1), alpha, stan::math::exp((-((gammaCC + multiply(get_base1(xCC_c, i, "xCC_c", 1), beta))) / alpha))));
            }
            current_statement_begin__ = 40;
            for (int i = 1; i <= nEC_c; ++i) {
                current_statement_begin__ = 41;
                lp_accum__.add(weibull_ccdf_log(get_base1(yEC_c, i, "yEC_c", 1), alpha, stan::math::exp((-((gammaCC + multiply(get_base1(xEC_c, i, "xEC_c", 1), beta))) / alpha))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
...
typedef model_T2EFullborrow_namespace::model_T2EFullborrow stan_model;
#ifndef USING_R
