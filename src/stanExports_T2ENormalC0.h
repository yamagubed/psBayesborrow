...
class model_T2ENormalC0 final : public model_base_crtp<model_T2ENormalC0> {
private:
  int nCT_o;
  int nCT_c;
  int nCC_o;
...
public:
  ...
  inline std::string model_name() const final { return "model_T2ENormalC0"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_T2ENormalC0_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
using stan_model = model_T2ENormalC0_namespace::model_T2ENormalC0;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_T2ENormalC0_namespace::profiles__;
}
#endif
#endif
