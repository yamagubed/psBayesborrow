...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ContFullborrow");
    reader.add_event(28, 26, "end", "model_ContFullborrow");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ContFullborrow
  : public stan::model::model_base_crtp<model_ContFullborrow> {
private:
        int nCT;
        int nCC;
        int nEC;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= nEC; ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(yEC, i, "yEC", 1), (gammaCC + multiply(get_base1(xEC, i, "xEC", 1), beta)), sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
...
typedef model_ContFullborrow_namespace::model_ContFullborrow stan_model;
#ifndef USING_R
