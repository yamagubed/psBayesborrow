...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BinFullborrow");
    reader.add_event(27, 25, "end", "model_BinFullborrow");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BinFullborrow
  : public stan::model::model_base_crtp<model_BinFullborrow> {
private:
        int nCT;
        int nCC;
        int nEC;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= nEC; ++i) {
                ...
                lp_accum__.add(bernoulli_log<propto__>(get_base1(yEC, i, "yEC", 1), inv_logit((gammaCC + multiply(get_base1(xEC, i, "xEC", 1), beta)))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
...
typedef model_BinFullborrow_namespace::model_BinFullborrow stan_model;
#ifndef USING_R
