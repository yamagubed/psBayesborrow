...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_T2ENoborrow");
    reader.add_event(34, 32, "end", "model_T2ENoborrow");
    return reader;
}
#include <stan_meta_header.hpp>
class model_T2ENoborrow
  : public stan::model::model_base_crtp<model_T2ENoborrow> {
private:
        int nCT_o;
        int nCT_c;
        int nCC_o;
...
public:
    model_T2ENoborrow(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_T2ENoborrow_namespace::model_T2ENoborrow";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_T2ENoborrow_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_T2ENoborrow_namespace::model_T2ENoborrow stan_model;
#ifndef USING_R
