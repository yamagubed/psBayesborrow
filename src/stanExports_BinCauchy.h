...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BinCauchy");
    reader.add_event(33, 31, "end", "model_BinCauchy");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BinCauchy
  : public stan::model::model_base_crtp<model_BinCauchy> {
private:
        int nCT;
        int nCC;
        int nEC;
...
typedef model_BinCauchy_namespace::model_BinCauchy stan_model;
#ifndef USING_R
